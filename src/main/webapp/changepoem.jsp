...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-8 poem-main">
            <s:form action="poemupdate" method="post">
                <s:hidden name="poem.id" value="%{poem.id}"/>
                <s:hidden name="poem.authorId" value="%{poem.authorId}"/>
                <s:textfield name="poem.title" label="标题" value="%{poem.title}" />
                <s:textarea cols="30" rows="3" name="poem.content"  label="内容" value="%{poem.content}"/>
                <s:textarea cols="30" rows="3" name="poem.translation"  label="译文" value="%{poem.translation}"/>
                <s:textfield name="poem.tags" label="标签" value="%{poem.tags}"/>
                </center>
                <s:submit value="修改"/>
            </s:form>
